...
---
layout: default
title: Workbook Three - The Connection Framework
nav_order: 30
has_children: true
parent: Lightning Path Workbooks
---

## Lightning Path Workbook Three: The Connection Framework
...
- **Title:** Lightning Path Workbook Three: The Connection Framework  
- **Author:** Dr. Michael Sosteric  
- **Publication Date:** Draft  
- **Most Recent PDF Download:** [lp-book-3.pdf](https://repo.lightningpath.org/assets/workbooks/wkbk3-connection/lp-book-3.pdf)
...
> Sosteric, M. (2024). *Lightning Path Workbook Three: The Connection Framework* (Version 0.95). Lightning Path Press. Retrieved from https://repo.lightningpath.org/assets/workbooks/wkbk3-connection/lp-book-3.pdf
